...
<body>
  ...
  <div class="navlist" id="navlist">
            ...
            <li>
              <a href="orders.php" id="orders"> <i class="fa fa-book listIcon "></i><span>All Orders</span> </a>
            </li>
          ...
          <table>
            ...
            <tbody>
              <?php
                ...
                $query = "SELECT * FROM users, orders WHERE users.user_id = orders.order_id";
              ...
              <tr>
                ...
                <td><?php echo htmlspecialchars($rows['order_id']); ?></td>
                <td><?php echo htmlspecialchars($rows['quantity']); ?></td>
                <td><?php echo htmlspecialchars($rows['tiffin_Type']); ?></td>
                <td><?php echo htmlspecialchars($rows['date']); ?></td>
                <td style='padding:0px;'>
                  <a href="orders.php?id=<?php echo $rows['id']; ?>&delete=true" class="button">Cancel Order</a>
                </td>
              </tr>
              <?php
                  }
...
?>                 
        ...
        <tr>
          ...
          <td><?php echo $rows['tiffinType'];?></td>

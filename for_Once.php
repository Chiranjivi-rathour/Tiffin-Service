...
<body>
  ...
  <div class="navlist" id="navlist">
      ...
      <?php
            ...
            $query = "SELECT users.user_id, users.username, users.email , users.phone ,users.address ,orders.order_id,orders.id, orders.quantity,orders.tiffin_Type,orders.date
            FROM users,orders 

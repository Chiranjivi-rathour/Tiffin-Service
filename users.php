...
<body>
  ...
  <div class="navlist" id="navlist">
            ...
            <li>
              <a href="users.php" id="user"> <i class="fa fa-user-plus  listIcon"></i> <span>Customers Details</span> </a>
            </li>
          ...
          ?>                 
            ...
            <tr>
              ...
              <td><?php echo $rows['phone'];?></td>
               ...
               <td >
           <a href="users.php?id=<?php echo $rows['user_id'];?>&delete=true" class="button" >Delete</a>
         </td>
            </tr>
